...
if (isset($_POST['submit'])) {
    ...
    $simpan =  mysqli_query($conn, "insert into kursus (judul_kursus,deskripsi,durasi)
...
<head>
    ...
    <title>Form Tambah Kursus</title>
    <!-- Favicon icon -->
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="" method="post">
                                        ...
                                        <div class="form-group">
                                            <label>Durasi :</label>
                                            <input type="text" class="form-control input-default " name="durasi" required>
                                        </div>
