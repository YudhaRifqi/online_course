...
if (isset($_POST['submit'])) {
    ...
    $simpan =  mysqli_query($conn, "insert into materi (kursus_id,judul,deskripsi,link_embed)
    values ('$kursus_id', '$judul', '$deskripsi', '$link_embed')");
                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Form Tambah Materi</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <form action="" method="post">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-lg" name="id_kursus" id="id_kursus">
                                                ...
                                                while ($row_kls = mysqli_fetch_assoc($result)) {
                                                ?>
                                                    <option value="<?= $row_kls["id"]; ?>"><?= $row_kls["judul_kursus"]; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label>Judul :</label>
                                            <input type="text" class="form-control input-default " name="judul" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control input-default " name="link_embed" required>
                                        </div>
